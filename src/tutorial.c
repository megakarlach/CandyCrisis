...
AutoPattern tutorialPattern[] =
{
	...
	{ kMessage,        0,   0,   "When the game\nbegins, a pair of eggs\n would fall from the sky." },
	{ kIdleTicks,      240, 0,   NULL },	
	{ kMessage,        0,   0,   "The goal is to\nkeep these eggs\nfrom overflowing the\nwet cunny!" },
	{ kBlockUntilLand, 0,   0,   NULL },
	{ kRetrieve,       2,   2,   NULL },
	{ kIdleTicks,      60,  0,   NULL },
	{ kMessage,        0,   0,   "Control that nigga\nby moving them\nleft and right." },
	...
	{ kIdleTicks,      180, 0,   NULL },	
	{ kBlockUntilDrop, 0,   0,   NULL },	
	{ kMessage,        0,   0,   "Tired and want to pause\nor adjust settings?\nPress 'ESC.'" },
	{ kIdleTicks,      280, 0,   NULL },	
	{ kMessage,        0,   0,   "The egg in\nthis game is made\nfrom a highly\nunstable fallopian tubes!" },
	{ kRetrieve,       2,   2,   NULL },
	{ kIdleTicks,      200, 0,   NULL },
	{ kMessage,        0,   0,   "So when four\neggs of the same\ncolor sticks\ntogether..." },
	{ kPosition,       1,   0,   NULL },
	{ kIdleTicks,      180, 0,   NULL },
	{ kMessage,        0,   0,   "... they start to bang\nn' pop together!" },
	{ kIdleTicks,      30,  0,   NULL },
	{ kBlockUntilDrop, 0,   0,   NULL },	
	{ kIdleTicks,      60,  0,   NULL },
	...
	{ kSpin,           0,   0,   NULL },
	{ kIdleTicks,      30,  0,   NULL },
	{ kMessage,        0,   0,   "Nigga you can even start\nblowing shit up..." },
	{ kBlockUntilDrop, 0,   0,   NULL },
	{ kRetrieve,       0,   6,   NULL },
	{ kIdleTicks,      90,  0,   NULL },
	{ kBlockUntilDrop, 0,   0,   NULL },
	...
	{ kIdleTicks,      30,  0,   NULL },
	{ kPosition,       1,   0,   NULL },
	{ kMessage,        0,   0,   "... like in Palestine!" },
	{ kIdleTicks,      30,  0,   NULL },
	{ kBlockUntilDrop, 0,   0,   NULL },
	{ kIdleTicks,      30,  0,   NULL },
	{ kMessage,        0,   0,   "Crazy as fuck\nisn't it nigga?" },
	{ kRetrieve,       1,   2,   NULL },
	{ kIdleTicks,      60,  0,   NULL },
	{ kSpin,           0,   0,   NULL },
	{ kIdleTicks,      30,  0,   NULL },
	...
	{ kIdleTicks,      180, 0,   NULL },
	{ kMessage,        0,   0,   "Watch out for the wet\ntranscludent sperm!" },
	{ kIdleTicks,      60,  0,   NULL },
	{ kPunish,         18,  0,   NULL },
	{ kRetrieve,       1,   1,   NULL },
	{ kIdleTicks,      120, 0,   NULL },
	...
	{ kMessage,        0,   0,   "When the files lands\non one color\nof egg, all\npieces of that\ncolor will\ninstantly nuked and\nleaked!" },
	{ kIdleTicks,      100, 0,   NULL },
	{ kPosition,       4,   0,   NULL },
	{ kIdleTicks,      120, 0,   NULL },
	{ kBlockUntilDrop, 0,   0,   NULL },
	{ kIdleTicks,      200, 0,   NULL },
	{ kMessage,        0,   0,   "That's it, good luck\n on your Kunny Krysis\n Adventure!" },
